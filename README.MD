...
sudo pacman -S pango kbd wget clang pv cmake git ntfs-3g fuse udisks2 htop ninja python gtk2 gconf libnotify libxss unzip dos2unix bc python2 xbindkeys neofetch openssh  
...
**Basic applications**  
sudo pacman -S firefox xterm notepadqq code  
